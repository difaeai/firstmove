...
export default function About() {
  return (
    <section id="about" className="relative overflow-hidden bg-white py-24 sm:py-28">
      <div className="pointer-events-none absolute right-0 top-1/3 h-72 w-72 rounded-full bg-azure-400/10 blur-[120px]" />
      <div className="container-page grid items-center gap-14 lg:grid-cols-2">
        {/* Visual */}
        <Reveal direction="right" className="order-2 lg:order-1">
          <div className="relative mx-auto max-w-md">
            <div className="glass-card relative overflow-hidden p-10">
              <div className="absolute inset-0 bg-grid-light bg-[size:32px_32px] opacity-60" />
              <div className="relative flex flex-col items-center text-center">
                <span className="text-7xl">🌍</span>
                <div className="mt-6 font-serif text-6xl font-700 text-gradient-gold">
                  {about.yearsNetwork}
                </div>
                <div className="mt-1 font-display text-xs font-600 uppercase tracking-[0.3em] text-navy-500">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              {[about.mission, about.vision].map((card) => (
                ...
                >
                  <h3 className="font-display text-sm font-700 uppercase tracking-wide text-gold-600">
                    {card.title}
                  </h3>
